...
int main(void)
{
    ...
    ArtDAQErrChk (ArtDAQ_CreateCICountEdgesChan(taskHandle,"Dev9/ctr0","",ArtDAQ_Val_Rising,0,ArtDAQ_Val_CountUp));

    ArtDAQErrChk (ArtDAQ_ExportPositionComparsionEvent(taskHandle,"/Dev9/PFI11", ArtDAQ_Val_Toggle, ArtDAQ_Val_ActiveHigh, ArtDAQ_Val_High, ArtDAQ_Val_PulseWidth_Implicit));
