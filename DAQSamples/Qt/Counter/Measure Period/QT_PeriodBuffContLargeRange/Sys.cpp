...
int main(void)
{
    ...
    ArtDAQErrChk (ArtDAQ_CreateCIPeriodChan(taskHandle,strChannelName,"",0.000000002,4.29496,ArtDAQ_Val_Seconds,ArtDAQ_Val_Rising,ArtDAQ_Val_LargeRng2Ctr,0.001,10,""));
