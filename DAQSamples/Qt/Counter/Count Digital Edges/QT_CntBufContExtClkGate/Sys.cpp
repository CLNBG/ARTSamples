...
int main(void)
{
    ...
    printf("Please enter gate source name,such as /Dev1/PFI1,Dev1 is the name identified in the DMC:");
    scanf("%s", strGateSource);
    ArtDAQErrChk (ArtDAQ_CreateTask("",&taskHandle));
    ArtDAQErrChk (ArtDAQ_CreateCICountEdgesChan(taskHandle,strChannelName,"",ArtDAQ_Val_Rising,0,ArtDAQ_Val_CountUp));
    ArtDAQErrChk (ArtDAQ_CfgSampClkTiming(taskHandle,strExternalClockSource,1000.0,ArtDAQ_Val_Rising,ArtDAQ_Val_ContSamps,1000));
    ArtDAQErrChk (ArtDAQ_CfgDigLvlPauseTrig(taskHandle, strGateSource, ArtDAQ_Val_High));
