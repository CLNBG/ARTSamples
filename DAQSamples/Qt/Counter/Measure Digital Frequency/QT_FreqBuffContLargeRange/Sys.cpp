...
int main(void)
{
    ...
    ArtDAQErrChk (ArtDAQ_CreateCIFreqChan(taskHandle,strChannelName,"",0.232831,50000000.000,ArtDAQ_Val_Hz,ArtDAQ_Val_Rising,ArtDAQ_Val_LargeRng2Ctr,0.001,10,""));
