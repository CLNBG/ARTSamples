...
from artdaq._task_modules.write_functions import (
    ...
    _write_ctr_freq, _write_ctr_time, _write_ctr_ticks, _write_position_comparsion_data)
...
class Task(object):
    ...
    def write_position_comparsion_data(self,position_array, pulse_width_array):
        position_array = numpy.asarray(position_array, dtype=numpy.uint32)
        pulse_width_array = numpy.asarray(pulse_width_array, dtype=numpy.uint32)
        num_sample_write = len(position_array)
        return _write_position_comparsion_data(self._handle, num_sample_write, position_array, pulse_width_array)
