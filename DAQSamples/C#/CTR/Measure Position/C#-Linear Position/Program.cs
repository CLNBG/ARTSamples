...
namespace Sys
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //step2: CreateChannel
            error = ArtDAQ.ArtDAQ_CreateCILinEncoderChan(taskHandle, strChannelName, "", ArtDAQ.ArtDAQ_Val_X2, 1, 0.0, ArtDAQ.ArtDAQ_Val_AHighBHigh, ArtDAQ.ArtDAQ_Val_Ticks, 0.001, 0.0, "");
