...
namespace Sys
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //step2: CreateChannel
            error = ArtDAQ.ArtDAQ_CreateCIAngEncoderChan(taskHandle, strChannelName, "", ArtDAQ.ArtDAQ_Val_X1, 1, 0.0, ArtDAQ.ArtDAQ_Val_AHighBHigh, ArtDAQ.ArtDAQ_Val_Degrees, 2000, 0.0, "");
