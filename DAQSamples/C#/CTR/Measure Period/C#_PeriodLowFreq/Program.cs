...
namespace Sys
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //step2: CreateChannel
            error = ArtDAQ.ArtDAQ_CreateCIPeriodChan(taskHandle, strChannelName, "", 0.00000002, 42.9496, ArtDAQ.ArtDAQ_Val_Seconds, ArtDAQ.ArtDAQ_Val_Rising, ArtDAQ.ArtDAQ_Val_LowFreq1Ctr, 0.0001, 4, "");
            ...
            Console.WriteLine("周期:{0:f9}S", data);
