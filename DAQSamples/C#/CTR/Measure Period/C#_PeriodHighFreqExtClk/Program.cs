...
namespace Sys
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //step2: CreateChannel
            error = ArtDAQ.ArtDAQ_CreateCIPeriodChan(taskHandle, strChannelName, "", 0.001, 0.100, ArtDAQ.ArtDAQ_Val_Seconds, ArtDAQ.ArtDAQ_Val_Rising, ArtDAQ.ArtDAQ_Val_HighFreq2Ctr, 0.0001, 4, "");
