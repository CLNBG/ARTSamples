...
namespace Sys
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //step2: CreateChannel
            error = ArtDAQ.ArtDAQ_CreateCIFreqChan(taskHandle, strChannelName, "", 0.232831, 50000000.000, ArtDAQ.ArtDAQ_Val_Hz, ArtDAQ.ArtDAQ_Val_Rising, ArtDAQ.ArtDAQ_Val_LargeRng2Ctr, 0.001, 10, "");
