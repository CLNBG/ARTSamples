...
namespace Sys
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //step1: CreateTask
            error = ArtDAQ.ArtDAQ_CreateTask("", out taskHandle);
            ...
            //step2: CreateChannel
            error = ArtDAQ.ArtDAQ_CreateCIFreqChan(taskHandle, strChannelName, "", 0.001, 0.100, ArtDAQ.ArtDAQ_Val_Hz, ArtDAQ.ArtDAQ_Val_Rising, ArtDAQ.ArtDAQ_Val_HighFreq2Ctr, 0.001, 4, "");
            ...
            error = ArtDAQ.ArtDAQ_CfgSampClkTiming(taskHandle, strSource, 100, ArtDAQ.ArtDAQ_Val_Rising, ArtDAQ.ArtDAQ_Val_ContSamps, 1000);
            GetErrorString(error);
            if (error < 0)
            {
                goto Exit;
