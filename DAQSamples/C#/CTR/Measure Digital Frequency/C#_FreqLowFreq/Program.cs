...
namespace Sys
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //step2: CreateChannel
            error = ArtDAQ.ArtDAQ_CreateCIFreqChan(taskHandle, strChannelName, "", 0.023284, 50000000.000, ArtDAQ.ArtDAQ_Val_Hz, ArtDAQ.ArtDAQ_Val_Rising, ArtDAQ.ArtDAQ_Val_LowFreq1Ctr, 0.001, 4, "");
            ...
            Console.WriteLine("Frequency:{0:f9}Hz", data);
