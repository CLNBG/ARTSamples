...
namespace Sys
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //step2: CreateChannel
            error = ArtDAQ.ArtDAQ_CreateCOPulseChanFreq(taskHandle, strChannelName, "", ArtDAQ.ArtDAQ_Val_Hz, ArtDAQ.ArtDAQ_Val_Low, 1.0, 1000.00, 0.50);
            ...
            //step3: Configure PauseTrig
            error = ArtDAQ.ArtDAQ_CfgDigLvlPauseTrig(taskHandle, "/Dev4/PFI0", ArtDAQ.ArtDAQ_Val_Low);
            GetErrorString(error);
            if (error < 0)
            {
                goto Exit;
