...
namespace Sys
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //step2: CreateChannel
            error = ArtDAQ.ArtDAQ_CreateCITwoEdgeSepChan(taskHandle, strChannelName, "", 0.000000100, 0.838900000, ArtDAQ.ArtDAQ_Val_Seconds, ArtDAQ.ArtDAQ_Val_Rising, ArtDAQ.ArtDAQ_Val_Falling, "");
