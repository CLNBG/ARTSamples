...
namespace Sys
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //step2: CreateChannel
            error = ArtDAQ.ArtDAQ_CreateAIRTDChan(taskHandle, strChannelName, "", 0.0, 100.0, ArtDAQ.ArtDAQ_Val_DegC, ArtDAQ.ArtDAQ_Val_Pt3750, ArtDAQ.ArtDAQ_Val_4Wire, ArtDAQ.ArtDAQ_Val_Internal, 0.004, 100.0);
            ...
            error = ArtDAQ.ArtDAQ_CfgSampClkTiming(taskHandle, "", 50.0, ArtDAQ.ArtDAQ_Val_Rising, ArtDAQ.ArtDAQ_Val_FiniteSamps, 1000);
            GetErrorString(error);
            if (error < 0)
            {
                goto Exit;
