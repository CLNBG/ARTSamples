...
namespace Sys
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //step2: CreateChannel
            error = ArtDAQ.ArtDAQ_CreateAIThrmcplChan(taskHandle, strChannelName, "", 0.0, 100.0, ArtDAQ.ArtDAQ_Val_DegC, ArtDAQ.ArtDAQ_Val_J_Type_TC, ArtDAQ.ArtDAQ_Val_BuiltIn, 25.0, "");
