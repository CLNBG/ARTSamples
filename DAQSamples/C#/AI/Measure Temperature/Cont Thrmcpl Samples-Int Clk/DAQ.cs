...
namespace Sys
{
    public partial class ArtDAQ
    {
       ...
       ******************************************************************************/
        ...
        [DllImport("Art_DAQ.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern Int32 ArtDAQ_CreateAIResistanceChan(IntPtr taskHandle, string physicalChannel, string nameToAssignToChannel, double minVal, double maxVal, Int32 units, Int32 resistanceConfig, Int32 currentExcitSource, double currentExcitVal, string customScaleNam);
