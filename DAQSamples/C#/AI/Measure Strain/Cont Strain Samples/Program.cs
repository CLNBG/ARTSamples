...
namespace Sys
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //step2: CreateChannel
            error = ArtDAQ.ArtDAQ_CreateAIStrainGageChan(taskHandle, "", "", -0.001, 0.001, ArtDAQ.ArtDAQ_Val_Strain, ArtDAQ.ArtDAQ_Val_FullBridgeI, ArtDAQ.ArtDAQ_Val_Internal, 2.50, 2.0, 0.0, 120.0, 0.285, 0.0, "");
