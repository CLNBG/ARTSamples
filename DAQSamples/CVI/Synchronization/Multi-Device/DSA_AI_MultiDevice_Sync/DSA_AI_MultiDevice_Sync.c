...
int main(void)
{
    ...
    /*********************************************/
	printf("Please enter the synchronization type, 0-sample clock, 1-reference clock:");
	scanf("%d", synchronizationType);
    ...
    ArtDAQErrChk (ArtDAQ_CreateAIVoltageChan(gMasterAItaskHandle,strMasterChannelName,"",ArtDAQ_Val_Cfg_Default,-10.0,10.0,ArtDAQ_Val_Volts,NULL));
    ...
    ArtDAQErrChk (ArtDAQ_CreateAIVoltageChan(gSlaveAItaskHandle,strSlaveChannelName,"",ArtDAQ_Val_Cfg_Default,-10.0,10.0,ArtDAQ_Val_Volts,NULL));
