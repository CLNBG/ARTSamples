...
*    VC_AI_Sync_MasterAIConvertClk.c
*
* Example Category:
*    Sync
*
...
int main(void)
{
	...
	printf("Please enter master card external clock source name,such as Dev1/PFI3,Dev1 is the name identified in the DMC:");
    ...
    if (mode == 0)
    {
        // Master device use internal clock 
        ArtDAQErrChk (ArtDAQ_CfgSampClkTiming(masterTaskHandle,"",10000.0,ArtDAQ_Val_Rising,ArtDAQ_Val_ContSamps,10000));
        // Export Master AI convert Clock
        ArtDAQErrChk (ArtDAQ_ExportSignal(masterTaskHandle, ArtDAQ_Val_AIConvertClock, strMasterExternalClock));

        // Slave device use external convert clock
    ...
    else
    {
        // Master device use internal clock 
        ArtDAQErrChk (ArtDAQ_CfgSampClkTiming(masterTaskHandle,"",10000.0,ArtDAQ_Val_Rising,ArtDAQ_Val_ContSamps,10000));
        // Export Master AI Sample Clock
        ArtDAQErrChk (ArtDAQ_ExportSignal(masterTaskHandle, ArtDAQ_Val_SampleClock, strMasterExternalClock));

        // Slave device use external sample clock
