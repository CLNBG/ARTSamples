...
int main(void)
{
	...
	ArtDAQErrChk (ArtDAQ_CreateCIPeriodChan(taskHandle,strChannelName,"",0.001,0.100,ArtDAQ_Val_Seconds,ArtDAQ_Val_Rising,ArtDAQ_Val_HighFreq2Ctr,0.0001,4,""));
    ArtDAQErrChk (ArtDAQ_CfgSampClkTiming(taskHandle,strExternalClock,100,ArtDAQ_Val_Rising,ArtDAQ_Val_ContSamps,1000));
