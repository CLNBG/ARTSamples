...
int main(void)
{
    ...
    printf("Please enter analog start trigger source name,such as /Dev1/APFI,Dev1 is the name identified in the DMC:");
	...
	ArtDAQErrChk (ArtDAQ_CfgAnlgEdgeStartTrig(taskHandle,strStartTriggerSource,ArtDAQ_Val_Rising,1.0));
