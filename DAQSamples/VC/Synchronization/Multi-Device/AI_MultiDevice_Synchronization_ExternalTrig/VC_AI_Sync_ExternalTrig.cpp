...
int main(void)
{
	...
	ArtDAQErrChk (ArtDAQ_CfgDigEdgeStartTrig(masterTaskHandle,"/Dev1/PFI1",ArtDAQ_Val_Rising));
	ArtDAQErrChk (ArtDAQ_CfgDigEdgeStartTrig(slaveTaskHandle,"/Dev2/PFI1",ArtDAQ_Val_Rising));
