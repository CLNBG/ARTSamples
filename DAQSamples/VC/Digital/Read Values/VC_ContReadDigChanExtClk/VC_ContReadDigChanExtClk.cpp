...
int main(void)
{
    ...
    ArtDAQErrChk (ArtDAQ_CreateDIChan(taskHandle,"Dev1/port0/line0","",ArtDAQ_Val_ChanPerLine));
    ArtDAQErrChk (ArtDAQ_CfgSampClkTiming(taskHandle,"/Dev1/PFI0",10000.0,ArtDAQ_Val_Rising,ArtDAQ_Val_ContSamps,1000));
