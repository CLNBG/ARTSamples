...
int main(void)
{
    ...
    ArtDAQErrChk (ArtDAQ_CreateDOChan(taskHandle,"Dev1/port0/line0","",ArtDAQ_Val_ChanPerLine));
    ArtDAQErrChk (ArtDAQ_CfgSampClkTiming(taskHandle,"/Dev1/PFI0",1000.0,ArtDAQ_Val_Rising,ArtDAQ_Val_FiniteSamps,1000));
