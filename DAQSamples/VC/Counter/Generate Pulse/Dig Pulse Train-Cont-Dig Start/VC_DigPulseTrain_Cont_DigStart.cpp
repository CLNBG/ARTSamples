...
int main(void)
{
    ...
    ArtDAQErrChk (ArtDAQ_CreateCOPulseChanFreq(taskHandle,"Dev1/ctr0","",ArtDAQ_Val_Hz,ArtDAQ_Val_Low,0.0,1.0,0.5));
    ArtDAQErrChk (ArtDAQ_CfgDigEdgeStartTrig(taskHandle,"/Dev1/PFI9",ArtDAQ_Val_Rising));
