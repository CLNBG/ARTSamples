...
int main(void)
{
    ...
    ArtDAQErrChk (ArtDAQ_CreateCIAngEncoderChan(taskHandle,"Dev1/ctr0","",ArtDAQ_Val_X4,0,0.0,ArtDAQ_Val_AHighBHigh,ArtDAQ_Val_Degrees,24,0.0,""));
    ArtDAQErrChk (ArtDAQ_CfgSampClkTiming(taskHandle,"/Dev1/PFI9",1000.0,ArtDAQ_Val_Rising,ArtDAQ_Val_ContSamps,1000));
