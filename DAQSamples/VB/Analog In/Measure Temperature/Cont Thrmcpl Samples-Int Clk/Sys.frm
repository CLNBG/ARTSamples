...
Private Sub Command_button_Click()
    ...
    ret = ArtDAQ_CreateAIThrmcplChan(TtaskHandle, str(0), 0, 0#, 100#, ArtDAQ_Val_DegC, ArtDAQ_Val_J_Type_TC, ArtDAQ_Val_BuiltIn, 25#, 0)
    If ret <> 0 Then
        MsgBox "创建AI Thrmcpl通道失败!"
...
Private Sub Form_Load()
    Label1.Caption = "本例程演示的是采集热电偶简易流程"
    bRun = False
End Sub
