...
Private Sub Command_button_Click()
    ...
    If ArtDAQ_ReadDigitalU32(taskHandle, 1, 10#, ArtDAQ_Val_GroupByChannel, data, 1, sampsRead, 0) <> 0 Then
        MsgBox "读取DI失败!"
        ArtDAQ_ClearTask (taskHandle)
        Exit Sub
    End If
    
    strr = "Acquired:" & CStr(data)
...
Private Sub Form_Load()
    Label1.Caption = "本例程演示的是从Port口进行DI读取的简易流程"
    bRun = False
End Sub
