...
Private Sub Command_button_Click()
    ...
    ret = ArtDAQ_CreateCIFreqChan(taskHandle, str(0), 0, 0.001, 0.1, ArtDAQ_Val_Hz, ArtDAQ_Val_Rising, ArtDAQ_Val_HighFreq2Ctr, 0.0001, 4, 0)
    If ret <> 0 Then
        MsgBox "创建计数器失败!"
...
Private Sub Form_Load()
    Label1.Caption = "本例程演示的是外部时钟连续模式下读取计数值的简易流程"
    bRun = False
End Sub
