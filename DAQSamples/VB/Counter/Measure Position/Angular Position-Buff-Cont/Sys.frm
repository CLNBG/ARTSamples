...
Private Sub Command_button_Click()
    ...
    ret = ArtDAQ_CreateCIAngEncoderChan(taskHandle, str(0), 0, ArtDAQ_Val_X4, 0, 0#, ArtDAQ_Val_AHighBHigh, ArtDAQ_Val_Degrees, 24, 0#, 0)
    If ret <> 0 Then
        MsgBox "创建编码通道失败!"
    ...
    str = StrConv("/Dev1/PFI9" & vbNullChar, vbFromUnicode)
...
Private Sub Form_Load()
    Label1.Caption = "本例程演示的是采用外部时钟进行角度位置测量的简易流程"
    bRun = False
End Sub
