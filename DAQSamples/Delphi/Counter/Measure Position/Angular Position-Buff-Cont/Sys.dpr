...
begin
  ...
  ret := ArtDAQ_CreateCIAngEncoderChan(taskHandle, pchar(strChannelName), '', ArtDAQ_Val_X4, 0, 0.0, ArtDAQ_Val_AHighBHigh, ArtDAQ_Val_Degrees, 24, 0.0, '');
  if(ret < 0) then
  begin
    Writeln('创建CTR0失败!');
    goto ExitSys;
