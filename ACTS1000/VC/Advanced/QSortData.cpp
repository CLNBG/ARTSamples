...
void CQSortData::SortAsc(LONG *data, int left, int right) 
{
	register int i,j;  
	LONG m,t;     
	i=left;j=right;
...
void CQSortData::SortDsc(LONG *data, int left, int right) 
{
	register int i,j;  
	LONG m,t;     
	i=left;j=right;
...
//############################################################
// 
void CQSortData::Sort(LONG *data, int left, int right)
{
