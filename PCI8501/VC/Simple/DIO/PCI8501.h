...
extern "C" {
	...
	//######################## 常规通用函数 #################################
	// 适用于本设备的最基本操作
	HANDLE DEVAPI FAR PASCAL PCI8501_CreateDevice(int DeviceID = 0);		// 创建设备对象
	HANDLE DEVAPI FAR PASCAL PCI8501_CreateDeviceEx(int nDevicePhysID = 0);	// 用物理ID创建设备对象
	int DEVAPI FAR PASCAL PCI8501_GetDeviceCount(HANDLE hDevice);			// 取得设备总台数
	BOOL DEVAPI FAR PASCAL PCI8501_GetDeviceCurrentID(HANDLE hDevice, PLONG pDeviceLgcID, PLONG pDevicePhysID);
	BOOL DEVAPI FAR PASCAL PCI8501_SetDevicePhysID(HANDLE hDevice, LONG nDevicePhysID);
    ...
    BOOL DEVAPI FAR PASCAL PCI8501_WritePortByte(HANDLE hDevice, __int64 pbPort, ULONG offserBytes, BYTE Value);
    BOOL DEVAPI FAR PASCAL PCI8501_WritePortWord(HANDLE hDevice, __int64 pbPort, ULONG offserBytes, WORD Value);
    BOOL DEVAPI FAR PASCAL PCI8501_WritePortULong(HANDLE hDevice, __int64 pbPort, ULONG offserBytes, ULONG Value);

    BYTE DEVAPI FAR PASCAL PCI8501_ReadPortByte(HANDLE hDevice, __int64 pbPort, ULONG offserBytes);
    WORD DEVAPI FAR PASCAL PCI8501_ReadPortWord(HANDLE hDevice, __int64 pbPort, ULONG offserBytes);
    ULONG DEVAPI FAR PASCAL PCI8501_ReadPortULong(HANDLE hDevice, __int64 pbPort, ULONG offserBytes);
...
#ifndef _PCI8501_DRIVER_
	#ifndef _WIN64
		#pragma comment(lib, "PCI8501_32.lib")
		#pragma message("======== Welcome to use our art company's products!")
		#pragma message("======== Automatically linking with PCI8501_32.dll...")
		#pragma message("======== Successfully linked with PCI8501_32.dll")
	#else
		#pragma comment(lib, "PCI8501_64.lib")
		#pragma message("======== Welcome to use our art company's products!")
		#pragma message("======== Automatically linking with PCI8501_64.dll...")
		#pragma message("======== Successfully linked with PCI8501_64.dll")
	#endif
