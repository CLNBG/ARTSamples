...
// 定义其他常量
#define DeviceName "PCI8501"       // 定义设备名
#define MAX_FREQUENCE     40000000 // 最高频率Hz
#define MAX_CHANNEL_COUNT 8
#define MAX_SEGMENT       2
#define MAX_RAM_SIZE 1024*16 // 每通道RAM的最大容量(点或字)

#define MAX_RAM_SIZE_16M 1024*1024*16 // 每通道RAM的最大容量(点或字)
...
#define DEFAULT_BUS_TYPE   PCI_BUS    // 设备类型(PXI)
#define DEFAULT_DEVICE_NUM 0x8501     // 设备编号(8501)

#define DEFAULT_VOLTBOTTOM_RANGE -50000
#define DEFAULT_VOLTTOP_RANGE     5000

#define DEFAULT_DATA_WIDTH 16     // 设备的精度(16位)
...
typedef struct _FILE_HEADER
{
	...
	PCI8501_PARA_AD ADPara;     // 保存硬件参数
	PCI8501_STATUS_AD ADStatus;     // 保存硬件参数
...
//#############################################################
// external declare
extern WORD ADBuffer1[MAX_CHANNEL_COUNT][MAX_SEGMENT][MAX_RAM_SIZE]; // 缓冲队列
extern WORD ADBuffer[MAX_CHANNEL_COUNT][MAX_SEGMENT][MAX_RAM_SIZE]; // 缓冲队列
