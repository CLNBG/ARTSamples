...
BOOL CADHistDoc::OnOpenDocument(LPCTSTR lpszPathName) 
{
	...
	//m_hFileObject = PXI8501_CreateFileObject(NULL, lpszPathName, PXI8501_modeRead);
	...
	//PXI8501_ReadFile(m_hFileObject, (WORD*)&m_Header, 0, m_HeaderSize);
	
	m_FileLength = (ULONG)((GetFileSize(m_hFileObject, NULL) - m_HeaderSize)/2);
	//m_FileLength = (ULONG)((PXI8501_GetFileLength(m_hFileObject) - m_HeaderSize)/2);
	...
	//PXI8501_ReadFile(m_hFileObject, m_ADBuffer, m_HeaderSize, m_ReadDataSize*2);
...
void CADHistDoc:: ReadData(void)
{
	...
	//PXI8501_ReadFile(m_hFileObject, m_ADBuffer, m_HeaderSize+(m_Offset*2), m_ReadDataSize*2);
...
void CADHistDoc::OnCloseDocument() 
{
	...
	//PXI8501_ReleaseFile(m_hFileObject);
