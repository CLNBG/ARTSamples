Module Module1
    ...
    Sub Main()
        ...
        Dim bReturn As Boolean ' 函数的返回值
        Dim nReadSizeWords As Int32  ' 每次读取AD数据个数
        Dim nRetSizeWords As Int32      ' 实际读取的数据个数
        Dim nReadSize As Int32
        Dim Index As Int32
        Dim pulDDR2Length As UInt32
        Dim ADData As UInt16
        Dim fVolt As Single     ' 将AD原始数据转换为电压值
        Dim nCurrentChannel As Int32 = 0  ' 采样通道数
        ...
        bReturn = PCI8501_InitDeviceAD(hDevice, ADPara) ' 初始化AD
