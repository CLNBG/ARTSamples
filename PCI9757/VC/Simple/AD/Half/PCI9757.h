...
#endif
	//######################## 设备对象管理函数 ##############################
	HANDLE DEVAPI FAR PASCAL PCI9757_CreateDevice(int DeviceLgcID = 0);     // 用逻辑号创建设备对象
...
#ifndef _PCI9757_DRIVER_
	#ifndef _WIN64
		#pragma comment(lib, "PCI9757_32.lib")
		#pragma message("======== Welcome to use our art company's products!")
		#pragma message("======== Automatically linking with PCI9757_32.dll...")
		#pragma message("======== Successfully linked with PCI9757_32.dll")
	#else
		#pragma comment(lib, "PCI9757_64.lib")
		#pragma message("======== Welcome to use our art company's products!")
		#pragma message("======== Automatically linking with PCI9757_64.dll...")
		#pragma message("======== Successfully linked with PCI9757_64.dll")
	#endif
