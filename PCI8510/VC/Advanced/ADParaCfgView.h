...
public:
	...
	CButton	m_Button_OutTrigSourceDir;
	CComboBox	m_Combo_ADINRange;
    ...
    CComboBox	m_Combo_OutTrigSource;
	CButton	m_Button_ClockOutput;
...
protected:
	...
	afx_msg void OnSelchangeCOMBOOutTrigSource();
	...
	afx_msg void OnSelchangeCOMBOADINRange();
	afx_msg void OnCHECKClockOutput();
	afx_msg void OnCHECKOutTrigSourceDir();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
