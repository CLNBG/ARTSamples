...
BEGIN_MESSAGE_MAP(CADHistFrm, CMDIChildWnd)
	...
	ON_BN_CLICKED(IDC_BUTTON_FIND_CHS, OnButtonFindChs)
	ON_BN_CLICKED(IDC_BUTTON_FIND_CHS_MAX, OnButtonFindChsMax)
...
void CADHistFrm::OnTimer(UINT_PTR nIDEvent) 
{
	...
	if (pDoc->m_Offset>=(pDoc->m_FileLength/pDoc->m_ChannelCount+256))
	{
		pDoc->m_Offset=(pDoc->m_FileLength/pDoc->m_ChannelCount+256);
		OnHistoryStop();
	}

	RedrawDataWindow();
	m_wndSetupBar.Invalidate();
...
void CADHistFrm::RedrawDataWindow(void)
{
    ...
    str.Format(_T("%d"), pDoc->m_ScreenOffset);
...
void CADHistFrm::OnButtonFindChs() 
{
	// TODO: Add your control notification handler code here
	
}

void CADHistFrm::OnButtonFindChsMax() 
{
	// TODO: Add your control notification handler code here
	
}

void CADHistFrm::OnButtonUpdateWave() 
{
	// TODO: Add your control notification handler code here
