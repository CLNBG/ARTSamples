...
public:
	...
	CEdit	    m_Edit_TopTringgerVolt;
	CEdit	    m_Edit_BottomTringgerVolt;
	CButton     m_Check_Analyze;
	//}}AFX_DATA
...
protected:
	...
	afx_msg void OnChangeEDITTopTriggerVolt();
	afx_msg void OnCHECKAnalyze();
	afx_msg void OnChangeEDITBottomTriggerVolt();
