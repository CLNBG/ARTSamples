...
Private Sub Command_DO_Click(Index As Integer)
    ...
    If PCI8510_SetDeviceDO(hDevice, bDOSts(0)) = False Then        ' 开关量输出
...
Private Sub Command_ReadDI_Click()
    ...
    If PCI8510_GetDeviceDI(hDevice, bDISts(0)) = False Then         ' 开关量输入
   ...
   For Index = 0 To 7 Step 1
        ...
        Me.Command_DI(Index).Caption = "开关0[开]"
        Me.Command_DI(Index).BackColor = RGB(0, 255, 255)
    Else
        Me.Command_DI(Index).Caption = "开关0[关]"
