...
Module Module1
    ...
    Dim wfmInfo_slave As ArtScope_wfmInfo
    Dim lsb(7) As Double
    ...
    Sub Main()
        ...
        If (ArtScope_ConfigureTriggerSyncSrc(taskHandle_master, triggerSynPulseSource) < 0) Then
            bError = True
            GoTo Error_close
        End If
        ...
        If (ArtScope_ConfigureClock(taskHandle_master, ARTSCOPE_VAL_CLK10M_PXI, 1, 1) < 0) Then
            bError = True
            GoTo Error_close
        End If
        ...
        If (ArtScope_ConfigureClock(taskHandle_slave, ARTSCOPE_VAL_CLK10M_PXI, 1, 0) < 0) Then
            bError = True
            GoTo Error_close
        End If
        ...
        ThreadPool.QueueUserWorkItem(AddressOf ReadDataThread)
