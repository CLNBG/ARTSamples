...
Module Module1
    ...
    ' clock parameters
    Dim inputClockSrc As String
    Dim freqDivision As Int32
    ...
    Sub Main()
        ...
        inputClockSrc = ARTSCOPE_VAL_CLK_IN
        freqDivision = 1
        ...
        If (ArtScope_ConfigureClock(taskHandle, inputClockSrc, freqDivision, 0) < 0) Then
            bError = True
            GoTo Error_close
        End If
