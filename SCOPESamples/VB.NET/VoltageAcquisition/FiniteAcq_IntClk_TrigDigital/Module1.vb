...
Module Module1
    ...
    Sub Main()
        ...
        triggerSource = ARTSCOPE_VAL_TRIGSRC_DTR
        ...
        If (ArtScope_ConfigureTriggerDigital(taskHandle, triggerSource, triggerSlope, triggerCount, triggerSensitivity) < 0) Then
            bError = True
            GoTo Error_close
        End If
