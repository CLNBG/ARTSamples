...
Module Module1
    ...
    Sub Main()
        ...
        refPosition = 0.0
        triggerSlope = ARTSCOPE_VAL_TRIGDIR_PULSE_GREATER
        triggerPolarity = ARTSCOPE_VAL_TRIGPOLAR_NEGATIVE
        ...
        If (ArtScope_ConfigureTriggerPulse(taskHandle, triggerSource, triggerLevel, triggerPolarity, triggerSlope, pulseWidth, triggerCoupling, triggerCount, triggerSensitivity) < 0) Then
            bError = True
            GoTo Error_close
        End If
