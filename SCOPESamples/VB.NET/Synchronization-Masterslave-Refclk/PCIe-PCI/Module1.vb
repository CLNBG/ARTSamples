...
Module Module1
    ...
    Dim triggerSyncPulseSouce As String
    ...
    Sub Main()
        ...
        triggerSyncPulseSouce = ARTSCOPE_VAL_TRIG_SYNC_0
        ...
        If (ArtScope_ConfigureTriggerSyncSrc(taskHandle_master, triggerSyncPulseSouce) < 0) Then
            bError = True
            GoTo Error_close
        End If
        ...
        If (ArtScope_ConfigureClock(taskHandle_master, ARTSCOPE_VAL_CLK_ONBOARD, 1, 1) < 0) Then
            bError = True
            GoTo Error_close
        End If
        ...
        If (ArtScope_ConfigureTriggerSyncSrc(taskHandle_slave, triggerSyncPulseSouce) < 0) Then
            bError = True
            GoTo Error_close
        End If
        ...
        If (ArtScope_ConfigureClock(taskHandle_slave, ARTSCOPE_VAL_CLK10M_MASTER, 1, 0) < 0) Then
            bError = True
            GoTo Error_close
        End If
