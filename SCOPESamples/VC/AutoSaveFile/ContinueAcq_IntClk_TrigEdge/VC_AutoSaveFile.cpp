/********************************************************************************
/  Auto Save File And Read File Example
/*******************************************************************************/
...
int main(void)
{
	...
	// Call the generic function to perform a continuous acquisition fetching in chunks
 	//ArtScope_GenericBinaryAcquisition();
						...
						int32* acquisitionMode)
{
	...
	printf("Type the channel name(0 or 0,1 or 0-1 or 0:1):");
	scanf("%s", channel);

	printf("Type the channel vertical range:\n0-20Vpp\n1-10Vpp\n2-2Vpp\n3-40Vpp\n4-16Vpp\n5-8Vpp\n6-4Vpp\n7-1.6Vpp\n8-800mVpp\n9-400mVpp\n10-160mVpp\n11-80mVpp\n12-40mVpp\n");
