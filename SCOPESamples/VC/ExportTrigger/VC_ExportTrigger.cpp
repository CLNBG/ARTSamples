...
int main()
{
	...
	int32 triggerOutPolarity = ARTSCOPE_VAL_TRIGOUT_POLAR_NEGATIVE;
	...
	handleErr(ArtScope_ExportTrigger(taskHandle, triggerOutWidth, triggerOutPolarity));
