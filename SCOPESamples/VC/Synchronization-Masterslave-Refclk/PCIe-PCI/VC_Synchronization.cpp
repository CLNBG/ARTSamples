...
int main()
{
	...
	handleErr(ArtScope_ConfigureClock(taskHandle_master, ARTSCOPE_VAL_CLK_ONBOARD, 1, 1));
	...
	handleErr(ArtScope_ConfigureTriggerSyncSrc(taskHandle_slave, triggerSyncPulseSouce));
	...
	handleErr(ArtScope_ConfigureClock(taskHandle_slave, ARTSCOPE_VAL_CLK10M_MASTER, 1, 0));
