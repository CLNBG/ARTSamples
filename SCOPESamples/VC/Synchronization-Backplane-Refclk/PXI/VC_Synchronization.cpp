...
int main()
{
	...
	printf("The screen will be updated every second.\n");
	...
	handleErr(ArtScope_ConfigureClock(taskHandle_master, ARTSCOPE_VAL_CLK10M_PXI, freqDivision, 1));
	...
	handleErr(ArtScope_ConfigureClock(taskHandle_slave, ARTSCOPE_VAL_CLK10M_PXI, freqDivision, 0));
	...
	// create thread to read data of slave
