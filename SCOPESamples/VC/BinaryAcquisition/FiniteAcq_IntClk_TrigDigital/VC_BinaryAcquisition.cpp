/********************************************************************************
/  Continuous Binary Samples Example, uses GenericBinaryAcquisition.h generic file
/*******************************************************************************/
...
int main()
{
	...
	strcpy(triggerSource, ARTSCOPE_VAL_TRIGSRC_DTR);
	...
	handleErr(ArtScope_ConfigureTriggerDigital(taskHandle, triggerSource, triggerSlope, triggerCount, triggerSensitivity));
