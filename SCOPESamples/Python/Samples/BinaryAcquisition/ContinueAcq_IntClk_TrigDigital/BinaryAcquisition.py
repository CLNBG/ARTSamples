...
triggerSource = TriggerSource.TRIGSRC_DTR
triggerSlope = TriggerSlope.TRIGDIR_NEGATIVE
triggerCount = 1
triggerSensitivity = 50
error_code = Functions.ArtScope_ConfigureTriggerDigital(taskHandle, triggerSource, triggerSlope, triggerCount, triggerSensitivity)
if error_code < 0:
    Functions.ArtScope_Close(taskHandle)
    check_for_error(error_code)
