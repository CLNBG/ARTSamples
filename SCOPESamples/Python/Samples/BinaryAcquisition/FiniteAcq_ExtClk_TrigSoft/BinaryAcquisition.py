...
inputClockSrc = InputClockSource.CLK_IN                 # external clock
freqDivision = 1                                        # frequency division
error_code = Functions.ArtScope_ConfigureClock(taskHandle, inputClockSrc, freqDivision, 0)
if error_code < 0:
    Functions.ArtScope_Close(taskHandle)
    check_for_error(error_code)
