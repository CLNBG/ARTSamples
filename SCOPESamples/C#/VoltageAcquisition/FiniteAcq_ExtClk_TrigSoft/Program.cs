...
namespace Sys
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Clock parameters
            string inputClockSrc = ART_SCOPE.ARTSCOPE_VAL_CLK_IN;
            ...
            if (ART_SCOPE.ArtScope_ConfigureClock(taskHandle, inputClockSrc, freqDivision, 0) < 0)
            {
                bError = true;
                goto Error_close;
            }

            if (ART_SCOPE.ArtScope_ConfigureTriggerSoftWare(taskHandle) < 0)
            {
                bError = true;
                goto Error_close;
            }
