...
namespace Sys
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Int32 windowMode = ART_SCOPE.ARTSCOPE_VAL_WINDOW_ENTERING;
            ...
            if (ART_SCOPE.ArtScope_ConfigureTriggerWindow(taskHandle, triggerSource, triggerLowLevel, triggerHighLevel, windowMode, triggerCoupling, triggerCount, triggerSensitivity) < 0)
            {
                bError = true;
                goto Error_close;
            }
