...
namespace Sys
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Int32 triggerOutPolarity = ART_SCOPE.ARTSCOPE_VAL_TRIGOUT_NEGATIVE_POLARITY;
            Int32 triggerOutWidth = 100;
            ...
            if (ART_SCOPE.ArtScope_ExportTrigger(taskHandle, triggerOutWidth, triggerOutPolarity) < 0)
            {
                bError = true;
                goto Error_close;
            }
            ...
            for (k = 0; k < numWfms; k++)
            {
                Console.Write("{0,8:d}(mV)\t", waveformPtr[k]);
            }
            Console.WriteLine("");
