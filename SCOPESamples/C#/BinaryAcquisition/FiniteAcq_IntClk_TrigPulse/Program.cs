...
namespace Sys
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Byte[] waveformPtr8 = new Byte[actualRecordLength * numWfms];
            ...
            if (ART_SCOPE.ArtScope_FetchBinary8(taskHandle, timeout, actualRecordLength, waveformPtr8, ref wfmInfo) < 0)
            {
                Console.WriteLine("Fetch Binary8 error!");
                goto Error_label;
            }
