//////////////////////////////////////////////////////
// This example program demonstrates multi cards synchronization in PXIE PXI PCIE PCI bus using common external clock.
...
namespace Sys
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (ART_SCOPE.ArtScope_ConfigureClock(taskHandle_master, ART_SCOPE.ARTSCOPE_VAL_CLK_IN,  1, 1) < 0)
            {
                bError = true;
                goto Error_close;
            }
            ...
            if (ART_SCOPE.ArtScope_ConfigureClock(taskHandle_slave, ART_SCOPE.ARTSCOPE_VAL_CLK_IN, 1, 0) < 0)
            {
                bError = true;
                goto Error_close;
            }
